...
export default function MemberAuthModal({
  ...
  const handleLogout = async () => {
    ...
    try {
      ...
      setOrders([]);
      setActivityLogs([]);
      success('Berhasil keluar dari akun member.', 'Sampai Jumpa');
    } catch {
      error('Gagal logout.');
    } finally {
      setBusy(false);
          ...
          <div className="space-y-6">
            <div className="text-center space-y-2">
              ...
              <span className="block text-[10px] font-bold tracking-[0.2em] uppercase text-neutral-400">
                ANGEL INC. MEMBERSHIP
              </span>
              <h3 className="font-serif text-2xl font-semibold text-neutral-900 dark:text-white">
                Masuk / Daftar Member
              </h3>
              <p className="text-xs text-neutral-500 dark:text-neutral-400 max-w-sm mx-auto">
                Gunakan nomor HP untuk login tanpa password. Dapatkan diskon eksklusif 5%, lacak histori pesanan & auto-fill saat checkout!
              </p>
            </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="Nama lengkap untuk pesanan"
            ...
            <div className="rounded-xl border border-amber-200/60 dark:border-amber-900/40 bg-amber-50/60 dark:bg-amber-950/20 p-3 text-[11px] text-amber-800 dark:text-amber-300 flex items-center gap-2">
              ...
              <span>Gunakan OTP demo <strong>1234</strong> untuk login instan.</span>
            </div>
          </div>
        )}
          ...
          <div className="space-y-6">
            <div className="text-center space-y-2">
              ...
              <p className="text-xs text-neutral-500 dark:text-neutral-400">
                Masukkan 4-digit kode yang dikirim ke <span className="font-bold text-neutral-900 dark:text-white">{phone}</span>
              </p>
            </div>
              ...
              <div>
                ...
                {otpHint && (
                  <p className="text-[11px] text-center text-neutral-400 mt-2">
                    Kode OTP Cepat: <strong className="text-black dark:text-white">{otpHint}</strong>
                  </p>
                )}
              </div>
        ...
        {step === 'profile' && member && (
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-2 border-b border-neutral-100 dark:border-neutral-800 pb-2">
              ...
              >
                <span>Histori Login / Logout</span>
              </button>
            </div>
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-3">
                  <div className="rounded-2xl border border-neutral-200 dark:border-neutral-800 bg-neutral-50/50 dark:bg-neutral-900/40 p-4 text-center">
                    ...
                    <span className="text-[10px] text-neutral-500 block mt-0.5">Semua Pembelian</span>
                  </div>
                  ...
                  <div className="rounded-2xl border border-neutral-200 dark:border-neutral-800 bg-neutral-50/50 dark:bg-neutral-900/40 p-4 text-center">
                    ...
                    <span className="text-[10px] text-neutral-500 block mt-0.5">Tercatat di Supabase</span>
                  </div>
                </div>
                ...
                <div className="p-4 rounded-2xl border border-neutral-200/80 dark:border-neutral-800 bg-white dark:bg-[#121316] space-y-2 text-xs">
                  ...
                  <p className="text-neutral-500 dark:text-neutral-400 text-[11px] leading-relaxed">
                    Data pengiriman dan kontak Anda otomatis terisi saat berbelanja di halaman checkout.
                  </p>
                </div>
              </div>
            )}
              ...
              <div className="space-y-3 max-h-64 overflow-y-auto pr-1">
                {loadingData ? (
                  <div className="py-8 text-center text-xs text-neutral-400">
                    ...
                    <span>Memuat histori pesanan…</span>
                  </div>
                ) : orders.length === 0 ? (
                  <div className="py-8 text-center text-xs text-neutral-400 space-y-2">
                    ...
                    <p>Belum ada transaksi dengan nomor ini.</p>
                  </div>
                ) : (
                  orders.map((ord) => (
                    <div
